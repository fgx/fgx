    ...
    QWidget(parent)
{
    ...
    comboScreenSize->addItem("- System Default -", "0x0");
    ...
    comboScreenSize->setCurrentIndex(0); // select default
    ...
    lineEditScreenSizeW->setVisible(false); // hide
    ...
    lineEditScreenSizeH->setVisible(false); // hide
...
void RenderingWidget::on_screensize_changed(QString)
{
    ...
    QString geom = lineEditScreenSizeW->text().append("x").append(lineEditScreenSizeH->text());
